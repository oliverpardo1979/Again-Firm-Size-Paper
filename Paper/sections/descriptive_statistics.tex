...
Table~\ref{tab:formal-worker-profile-2025} helps interpret the left panel of Figure~\ref{fig:income-formality-comparison}. Formal solo work is a selected but heterogeneous category: 82.1 percent are own-account workers and 50.9 percent have higher education, with a sizable concentration in professional and administrative services. At the same time, 16.2 percent of formal solo workers are domestic workers and 15.6 percent are in transport. The raw U-shape among formal workers should therefore be interpreted as evidence of worker composition within formal solo work, rather than as evidence that all formal solo workers are high-earning professionals.

\input{Paper/sections/descriptive_formal_worker_profile_2025_table}

Figure~\ref{fig:minwage-distribution-formality-size} provides a second view of the same formality-size split. Instead of plotting mean wages, it plots smoothed kernel densities of hourly wages relative to the statutory hourly minimum in 2025. The vertical line marks one minimum wage, and the labels on the right report each firm-size category's employment share within the corresponding formality group. Among formal workers, the categories from 4--5 to 51--100 workers are visibly concentrated around one minimum wage. Appendix Table~\ref{tab:minimum-wage-bunching-2025} quantifies this pattern: between 36.9 and 42.7 percent of formal workers in these categories earn between 0.9 and 1.1 hourly minimum wages. Appendix Table~\ref{tab:minimum-wage-monthly-bunching-2025} shows a similar pattern when hourly wages are converted into implied monthly labor income: between 39.1 and 46.3 percent of formal workers in firms with 4--100 workers are between 0.9 and 1.1 monthly minimum wages. Formal solo workers and formal workers in 101+ firms have wider upper tails; in monthly terms, their 75th percentiles are 2.11 and 2.46 minimum wages, respectively. Among informal workers, the distribution is shifted downward: 73.5 percent of solo workers and 65.9 percent of workers in firms with 2--3 workers earn less than 0.9 hourly minimum wages. This evidence complements Figure~\ref{fig:income-formality-comparison}: the minimum wage appears as a visible compression benchmark in formal wage setting, while informal employment contains much more mass below that benchmark.

\begin{figure}[!htbp]
  \centering
  \includegraphics[width=\textwidth]{fig77_\figurelang.png}
  \caption{Kernel density of hourly wages relative to the statutory hourly minimum by firm size and formality status, 2025}
